...
require "feedjira/atom_entry_elements"
...
require "feedjira/parser/entry_media"
require "feedjira/rss_entry_utilities"
require "feedjira/itunes_feed_utilities"
...
require "feedjira/parser/atom_link"
require "feedjira/parser/atom_source"
...
module Feedjira
  ...
  def parser_for_xml(xml)
    start_of_doc = xml.slice(0, 100_000)
